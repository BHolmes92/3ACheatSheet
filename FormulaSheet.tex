...
\subsection{Loading}
\begin{align*}
	\sigma_m = mean\textit{ }stress = (\sigma_{max} + \sigma_{min})/2 \\
	\sigma_a = stress\textit{ }amplitude = (\sigma_{max} - \sigma_{min})/2 \\
	R = stress\textit{ }ratio = \sigma_{min} /\sigma_{max})\\
	A = stress\textit{ }ratio = \sigma_a /\sigma_m)\\
	Loading\textit{ }Cycle: period\textit{ }between\textit{ }peaks
\end{align*}
\subsection{Fatigue Testing}
\begin{align*}
	tan2\theta_\sigma = \frac{2\tau_{xy}}{\sigma_x-\sigma_y}\\
	\sigma_{1,2} = \frac{\sigma_x + \sigma_y}{2} \pm \sqrt{\left(\frac{\sigma_x-\sigma_y}{2}\right)^2 + \tau^2_{xy}}\\
	\textit{Max }\sigma_{norm} = \frac{1}{2}(\sigma_x + \sigma_y) + \sqrt{\left[\frac{1}{2}\sigma_x-\sigma_y\right]^2 + \tau_{xy}^2}\\
...
\begin{align*}
	K_ttan2\theta_\sigma = \frac{2\tau_{xy}}{\sigma_x-\sigma_y}\\
	\sigma_{1,2} = \frac{\sigma_x + \sigma_y}{2} \pm \sqrt{\left(\frac{\sigma_x-\sigma_y}{2}\right)^2 + \tau^2_{xy}}\\
	\textit{Max }\sigma_{norm} = \frac{1}{2}(\sigma_x + \sigma_y) + \sqrt{\left[\frac{1}{2}\sigma_x-\sigma_y\right]^2 + \tau_{xy}^2}\\
	\textit{Min }\sigma_{norm} = \frac{1}{2}(\sigma_x - \sigma_y) - \sqrt{\left[\frac{1}{2}\sigma_x-\sigma_y\right]^2 + \tau_{xy}^2}\\
\end{align*}
